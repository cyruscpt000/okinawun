...
export const ITINERARY: DayPlan[] = [
  {
    ...
    items: [
      ...
      { time: '15:00', activity: '琉球新麵 通堂 小祿店', location: '那霸市金城5-4-6', type: 'food', mapcode: '33095245*67', phone: '+81 98 857 5577', memo: '機場10分鐘' },
      ...
      { time: '21:00', activity: '美國村 American Village', location: '北谷町美濱', type: 'shopping', mapcode: '33525381*36', duration: '30-40分鐘車程' }
    ]
  },
  {
    date: '2026-04-18',
    ...
    title: 'Day 2: 那霸市場與美景',
    items: [
      { time: '09:30', activity: '第一牧志公設市場', location: '那霸市松尾2-10-1', type: 'food', mapcode: '33157264*75', phone: '+81 98 867 6560', memo: '開放時間：8:00-22:00，星期日休息', duration: '23分鐘車程' },
      { time: '11:00', activity: '沖繩世界 Okinawa World', location: '南城市玉城字前川1336', type: 'sightseeing', mapcode: '232495333*52', phone: '+81 98 949 7421', duration: '半小時車程' },
      { time: '13:00', activity: '一心壽喜燒 Oniku no Isshin', location: '那霸市', type: 'food', mapcode: '33156166*80', phone: '+81 98 866 0736', link: 'https://www.tablecheck.com/zh-TW/isshin-okinawa/reserve/message', memo: '午餐：1個月前book' },
      { time: '16:00', activity: '國際通商店街', location: '那霸市國際通', type: 'shopping', mapcode: '33 157 414*82', phone: '+81 98 863 2755' },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '12:00', activity: '浜之家海鮮料理', location: '恩納村恩納2097', type: 'food', mapcode: '206035729*50', phone: '+81 98 965 0870', memo: '11:00-21:30' },
      { time: '15:00', activity: '萬座毛 深度遊', location: '恩納村恩納', type: 'sightseeing', mapcode: '206312128*16' },
      { time: '18:00', activity: '燒肉 琉球之牛 恩納店', location: '恩納村前兼久909-2', type: 'food', mapcode: '206096687*25', phone: '+81 98 965 2233', memo: '2個月前卜', duration: '15分鐘' }
    ]
  }
];
